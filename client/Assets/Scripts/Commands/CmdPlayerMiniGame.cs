...
{
    public class CmdPlayerMiniGame : Command
    {
        public int id;
        ...
        public CmdPlayerMiniGame(IActionListener actionListener, int action, object p)
        {
        ...
        public override void Paint(MyGraphics g)
        {
            ...
            if (player != null)
            {
                ...
                if (isOnline)
                {
                    myFontNameOnline.DrawString(g, (id + 1) + ": " + player.name, x + 90 + xBonus, yText, 0);
                }
                else
                {
                    myFontNameOffline.DrawString(g, (id + 1) + ": " + player.name, x + 90 + xBonus, yText, 0);
                }
